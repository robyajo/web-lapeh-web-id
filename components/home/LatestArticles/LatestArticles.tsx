...
export default function LatestArticles() {
  ...
  if (data.length > 0 && data[0].articles.length > 0) {
    const allArticles = data[0].articles.sort((a: any, b: any) => {
    ...
    return (
      <>
        <div className="flex flex-col-reverse sm:flex-col gap-6 md:gap-12 py-6 md:py-10 max-w-380 w-full mx-auto">
