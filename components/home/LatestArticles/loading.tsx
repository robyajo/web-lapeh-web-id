...
export default function Loading() {
  return (
    <div>
      <div className="flex flex-col-reverse sm:flex-col gap-12 py-10 max-w-380 w-full mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
          <Skeleton className="bg-[#a1a1a1] rounded-none box h-42.5"></Skeleton>
          <div className="flex flex-col gap-0.5 justify-between">
            ...
            <div className="flex justify-between sm:items-center gap-2 mt-2">
              ...
              <div className="flex justify-end">
                <Skeleton className="bg-white h-10.5 w-14 border border-[#a1a1a1] rounded-full flex items-center justify-center">
