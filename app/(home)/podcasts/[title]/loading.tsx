import SkeletonCard from "@/components/home/LatestPodcasts/SkeletonCard";
import { Skeleton } from "@/components/ui/skeleton";

export default function Loading() {
  return (
    <div className="max-w-380 w-full mx-auto px-4 pb-12 md:pt-8 sm:pt-4 xs:pt-2 md:pb-4 sm:pb-2 xs:pb-2">
      <div className="flex items-center justify-between gap-20 md:gap-0 py-4 md:pt-8 md:pb-24">
        <div className="flex gap-2">
          <Skeleton className="bg-[#a1a1a1] h-6.25 w-6.25 rounded-none"></Skeleton>
          <Skeleton className="bg-[#a1a1a1] h-6.25 w-22.5 rounded-none"></Skeleton>
        </div>
        <Skeleton className="bg-[#a1a1a1] h-7 w-39.5 rounded-none"></Skeleton>
      </div>

      <div className="max-w-300 w-full mx-auto flex flex-col md:flex-row flex-wrap gap-24">
        <div className="flex flex-col lg:w-1/4">
          <Skeleton className="bg-[#a1a1a1] h-75 max-w-75 w-full rounded-none"></Skeleton>
          <div className="flex justify-between mt-8 pb-12">
            <Skeleton className="bg-[#a1a1a1] h-7 w-22.75 rounded-none"></Skeleton>
      ...
      <div className="pb-12 md:pb-48">
        <Skeleton className="bg-[#a1a1a1] h-0.5 mt-38 mb-12 md:mb-24 w-full"></Skeleton>
        <Skeleton className="bg-[#a1a1a1] h-16 md:h-28 mt-12 mb-12 md:mb-24 w-full rounded-none"></Skeleton>
        <div className="grid grid-cols-1 md:grid-cols-3  xl:grid-cols-3 max-w-380 w-full mx-auto">
          <SkeletonCard />
          <SkeletonCard />
          <SkeletonCard />
        </div>
